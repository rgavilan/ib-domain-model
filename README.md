...
| Módulo         | Modelo de dominio                                            |
| Tipo           | Software                                                     |
| Objetivo       | Modelo de dominio para el proyecto Backend SGI (ASIO).       |
| Estado         | **50%** Modelo de dominio para el proyecto Backend SGI (ASIO). |
| Próximos pasos | Ampliarlo acorde con la estructura de la ontología.          |
